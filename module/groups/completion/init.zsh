...
zstyle ':completion:*:corrections' format ' %F{#A3BE8C}-- %d (errors: %e) --%f'
zstyle ':completion:*:descriptions' format ' %F{#88C0D0}-- %d --%f'
zstyle ':completion:*:messages' format ' %F{#B48EAD}-- %d --%f'
zstyle ':completion:*:warnings' format ' %F{#BF616A}-- no matches found --%f'
zstyle ':completion:*:default' list-prompt '%S%M matches%s'
zstyle ':completion:*' format ' %F{#88C0D0}-- %d --%f'
