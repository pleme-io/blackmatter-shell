...
in {
  imports = [
    ...
    # direnv-lib replaced by blackmatter-direnv module
  ];
  ...
  config = mkIf cfg.enable {
    ...
    home.packages = with pkgs;
      ...
      ++ [
        ...
        # Development tools
        # direnv + nix-direnv managed by blackmatter-direnv module
    ...
    # .direnvrc managed by blackmatter-direnv module
    ...
    # direnv library managed by blackmatter-direnv
  };
}
